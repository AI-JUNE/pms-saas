...
export const CONFIGS: Record<string, CrudConfig> = {
  ...
  tests: { table: tests, resource: 'test', scope: 'project', codePrefix: 'TC', orderAsc: true, fields: ['title','reqCode','type','priority','steps','expected','assignee','status','result'], required: ['title'] },
