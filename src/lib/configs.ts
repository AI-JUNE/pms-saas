...
export const CONFIGS: Record<string, CrudConfig> = {
  ...
  issues: { table: issues, resource: 'issue', scope: 'project', codePrefix: 'ISS', fields: ['title','description','type','priority','status','assignee','dueDate','labels','storyPoints','sprintId','epic','reqCode'], required: ['title'], journal: true },
