...
export const CONFIGS: Record<string, CrudConfig> = {
  ...
  tasks: { table: tasks, resource: 'task', scope: 'project', codePrefix: 'WBS', orderAsc: true, fields: ['name','phase','assignee','status','startDate','endDate','progress','reqCode','predecessor','parentId','plannedHours','actualHours'], required: ['name'], guardDelete: GUARD_TASK_CHILDREN },
