...
export default function Page() {
  return <ResourceView title="인터페이스" subtitle="시스템 간 인터페이스를 설계·관리합니다." endpoint="/api/interfaces" projectScoped entity="interfaces"
    columns={[{key:'code',label:'코드'},{key:'name',label:'인터페이스',strong:true},{key:'srcSystem',label:'송신'},{key:'dstSystem',label:'수신'},{key:'protocol',label:'프로토콜'},{key:'format',label:'포맷'},{key:'cycle',label:'주기'},{key:'owner',label:'담당'},{key:'testStatus',label:'연동테스트'},{key:'status',label:'상태',badge:true}]}
