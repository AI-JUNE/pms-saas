...
export default function Page() {
  return <ResourceView title="리스크" subtitle="리스크를 식별·평가합니다. 등급은 발생가능성×영향도로 자동 산정됩니다." endpoint="/api/risks" entity="risks" projectScoped
    ...
    columns={[{key:'code',label:'코드'},{key:'title',label:'제목',strong:true},{key:'probability',label:'발생'},{key:'impact',label:'영향'},{key:'level',label:'등급',badge:true},{key:'status',label:'상태',badge:true},{key:'dueDate',label:'대응기한'},{key:'owner',label:'담당'}]}
